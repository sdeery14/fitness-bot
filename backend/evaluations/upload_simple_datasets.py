...
def upload_simple_dataset(dataset_name: str, agent_name: str):
    ...
    print(f"✓ Loaded: {dataset_data['name']} v{dataset_data['version']}")
    ...
    if experiment is None:
        ...
        print(f"\n✓ Using experiment: {experiment_name} (ID: {experiment.experiment_id})")
    ...
    print(f"\n{'='*80}")
    print(f"✓ Successfully uploaded dataset to MLflow!")
    print(f"{'='*80}")
